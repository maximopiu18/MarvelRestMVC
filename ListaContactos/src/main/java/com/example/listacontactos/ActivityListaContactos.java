...
public class ActivityListaContactos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactos = new Contactos(ActivityListaContactos.this);
        cargarMisPreferencias();
        crearSpinner();
        cargarDatos();
        gridView.setAdapter( new AdapterGrid(ActivityListaContactos.this, nombre, telefono, urlImagen));
        lista.setAdapter( new AdapterList(ActivityListaContactos.this, nombre, telefono, imagenes, iddatabase));

        imgButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityListaContactos.this, Activity_NuevoContacto.class);
    ...
    public ActivityListaContactos(){

    }
    public void crearSpinner()
    {
        adapterSpinner = new ArrayAdapter<String>(ActivityListaContactos.this, android.R.layout.simple_list_item_1, listaSpinner);
    ...
    public void cargarMisPreferencias(){
        ...
        utils.cargarPreferencias(ActivityListaContactos.this);
    ...
    public void guardarMisPreferencias(int position){
        Utils utils = new Utils();
        utils.guardarPreferencias(ActivityListaContactos.this, String.valueOf(position));
    }
